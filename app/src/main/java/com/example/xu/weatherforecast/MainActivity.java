...
import com.example.xu.adapter.ViewPagerAdapter;
import com.example.xu.bean.TodayWeather;
import com.example.xu.listener.MyLocationListener;
import com.example.xu.util.NetUtil;
...
public class MainActivity extends Activity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private TextView cityTv, timeTv, humidityTv, weekTv, pmDataTv, pmQualityTv,
            temperatureTv, climmateTv, windTv, city_name_Tv;
    ...
    void initView() {
        ...
        climmateTv = (TextView)findViewById(R.id.climate);
    ...
    void updateTodayWeather(TodayWeather todayWeather) {
        ...
        climmateTv.setText(todayWeather.getType());
